...
python "$PROJDIR"/project/datasets/builder/add_atoms_to_pairs.py "$PROJDIR"/project/datasets/DB5/interim/pairs "$PROJDIR"/project/datasets/DB5/final/raw --num_cpus 32 --rank "$1" --size "$2"